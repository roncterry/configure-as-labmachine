...
echo -e "${LTGREEN}COMMAND:${GRAY}  cp ~/.config/dconf/user ../files/${NC}"
cp ~/.config/dconf/user ../files/
echo -e "${LTGREEN}COMMAND:${GRAY}  cp ~/.config/mimeapps.list ../files/${NC}"
cp ~/.config/mimeapps.list ../files/
