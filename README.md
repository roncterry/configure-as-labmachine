...
| **base_container_env_only** | Configure only the base container runtime environment required to run labs (sudo, default directories, wallpapers, user environment, podman/helm, remote access, tools)                                                                                                                                           |
